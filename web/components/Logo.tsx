...
export function AkiraIcon({ size = 32, className = '' }: { size?: number; className?: string }) {
  return (
...
export function AkiraWordmark({ className = '' }: { className?: string }) {
  return (
...
export default function AkiraLogo({ size = 32, showText = true, textSize = 'text-2xl', className = '' }: { size?: number; showText?: boolean; textSize?: string; className?: string }) {
  return (
